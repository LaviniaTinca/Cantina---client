//am incercat sa implementez aici partea de responsive pe navbar3
    ...
    >
      ...
      >
        ...
        <Box display="flex" justifyContent="space-between" columnGap="20px" zIndex="2">
          {isNonMobileScreens && !isAuthenticated && (
          ...
          {isAuthenticated && (
            <>
              <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                <IconButton
                  style={{ width: "20px", height: "20px", marginLeft: isNonMobileScreens ? "30px" : "10px" }}
                  onClick={handleOpen}
                  sx={{ color: "black", marginLeft: isNonMobileScreens ? "5px" : 0 }}
                >
                  <Avatar src={user.picturePath} onClick={handleOpen} />
                </IconButton>
